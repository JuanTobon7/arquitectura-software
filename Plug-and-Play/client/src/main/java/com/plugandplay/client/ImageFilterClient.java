package com.plugandplay.client;

import com.plugandplay.core.ProcessingContext;
import com.plugandplay.app.orchestrator.ParallelOrchestrator;
...
public class ImageFilterClient extends JFrame {
    ...
    private JPanel buildLeftPanel() {
        ...
        componentManager.installPluginFolder(Paths.get("plugins").toAbsolutePath().normalize());
        refreshPlugins();
